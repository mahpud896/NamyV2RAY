...
import com.namy.v2ray.BuildConfig
import com.namy.v2ray.databinding.ActivityMainBinding
import com.namy.v2ray.dto.EConfigType
import com.namy.v2ray.extension.toast
import rx.Observable
import rx.android.schedulers.AndroidSchedulers
import java.util.concurrent.TimeUnit
import com.namy.v2ray.helper.SimpleItemTouchHelperCallback
import com.namy.v2ray.service.V2RayServiceManager
import com.namy.v2ray.util.*
import com.namy.v2ray.viewmodel.MainViewModel
...
//    }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.feedback -> {
                Utils.openUri(this, AppConfig.NamyV2RAYIssues)
            }
            R.id.promotion -> {
